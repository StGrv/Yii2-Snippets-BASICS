...
<?= Html::tag('h2', 'Humen must explore h2', ['class' => 'post-title', 'style' => 'font-size:30px; color:red']) ?>

<?= Html::tag('h3', 'Humen must explore h3', ['class' => 'post-subtitle']) ?>

<?=Html::tag('p', 'Humen must explore p', ['class' => 'post-meta'] ) ?>
